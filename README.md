# Sipit — Trip Money Tracker

A calm trip-money workspace for tracking expenses, contributions, balances, tasks, notes, and settle-up transfers. It runs in a browser, saves locally, and remains useful offline after the first hosted visit.

## What's improved

- Desktop-first glass workspace with a persistent trip sidebar and clear section navigation.
...
✅ Collected: ₱3,000 (39%)
🔴 Still needed: ₱4,650
👥 Each person: ₱1,275 (6 people)

Where everyone stands:
• Josh: gave ₱1,500 — ₱225 extra
• Zendee: gave ₱1,000 — needs ₱275 more
...
```

## 🏝️ More than one trip

At the top you'll see trip buttons. Tap **＋ New trip** for the next outing (Christmas party, next beach trip, anything) — your friends' names come along automatically, with a fresh empty list. Tap a trip's name to switch to it, and use the ✏️ beside the big title to rename it. Every trip keeps its own money and list.
